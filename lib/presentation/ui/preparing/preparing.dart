      ...
      body: BlocBuilder<OrderRemoteBloc, OrderRemoteState>(
        builder: (context, state) {
          if (state is OrdersFetchedState) {
            final preparing =
                state.orders.where((element) => element.status == OrderStatus.preparing).toList();
            return preparing.isEmpty ? const Center(child: Text('Hech narsa yo\'q')) : Column(
              children: [
                Expanded(
                  child: ListView.separated(
                      ...
                      return Container(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            ...List.generate(order.items.length, (index) => Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                ...
                                Row(
                                  ...
                                  children: [
                                    Text('Soni: ${order.items[index].quantity} ta',
                                        style:
                                        const TextStyle(fontWeight: FontWeight.w500, fontFamily: 'Sora')),
                              ...
                              children: [
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    ZoomTapAnimation(
                                      onTap: () {
                                        context.read<OrderRemoteBloc>().add(ChangeOrderStatusEvent(order.id!, OrderStatus.onRoute));
                                      },
                                      child: Container(
                                        padding: const EdgeInsets.all(10.0),
                                        decoration: BoxDecoration(
                    ...
                    }, separatorBuilder: (BuildContext context, int index) { return const Gap(16);},
                  ),
                ),
